<%-- 
    Document   : juego
    Created on : 25/09/2017, 06:43:41 PM
    Author     : Juan Benitez
--%>
...
<%
    ...
    int wins = alguien.getP_ganados();
    int loses = alguien.getP_perdidos();
    
%>
<!DOCTYPE html>
<html>
    <head>
        <title>Aplicaciçon de Ahorcado<%= wins %></title>
        ...
        <script>
            ...
            var palabraEscogida = '<%= request.getSession().getAttribute("palabra")%>';
            var aciertos = [];
                                ...
                                caja.dialog({
                                    ...
                                    buttons: {
                                        "Ok": function () {
                                           ...
                                           document.location.href="/AhorcadoWeb/usuario?accion=modificarG";
                                        }
                                    }
                                });
                            }
                                ...
                                caja.dialog({
                                    ...
                                    buttons: {
                                        "Ok": function () {
                                           ...
                                           document.location.href="/AhorcadoWeb/usuario?accion=modificarP";
                                        }
                                    }
                                });
                            }
    ...
    <center>
        <h1>
            <%= request.getSession().getAttribute("palabra")%>
        </h1>
